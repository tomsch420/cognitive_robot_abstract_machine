...
class BehaviourQueryResultDAO(
    ...
    eql_duration_ms_id: Mapped[int] = mapped_column(
        ForeignKey("MeanAndStandardDeviationDAO.database_id", use_alter=True),
        nullable=True,
        use_existing_column=True,
    )
    sql_translation_duration_ms_id: Mapped[int] = mapped_column(
        ForeignKey("MeanAndStandardDeviationDAO.database_id", use_alter=True),
        nullable=True,
        use_existing_column=True,
    )
    sql_execution_duration_ms_id: Mapped[int] = mapped_column(
        ForeignKey("MeanAndStandardDeviationDAO.database_id", use_alter=True),
        nullable=True,
        use_existing_column=True,
    )

    eql_duration_ms: Mapped[MeanAndStandardDeviationDAO] = relationship(
        "MeanAndStandardDeviationDAO",
        uselist=False,
        foreign_keys=[eql_duration_ms_id],
        post_update=True,
    )
    sql_translation_duration_ms: Mapped[MeanAndStandardDeviationDAO] = relationship(
        "MeanAndStandardDeviationDAO",
        uselist=False,
        foreign_keys=[sql_translation_duration_ms_id],
        post_update=True,
    )
    sql_execution_duration_ms: Mapped[MeanAndStandardDeviationDAO] = relationship(
        "MeanAndStandardDeviationDAO",
        uselist=False,
        foreign_keys=[sql_execution_duration_ms_id],
        post_update=True,
    )
