...
These classes are specifically designed to NOT be in sys.modules when the forward
reference resolution test runs, to reproduce the bug where multiple forward references
can't be resolved iteratively.
"""
