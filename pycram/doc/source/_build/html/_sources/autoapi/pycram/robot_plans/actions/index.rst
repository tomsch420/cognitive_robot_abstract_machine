...
.. py:module:: pycram.robot_plans.actions
...
.. toctree::
   ...
   /autoapi/pycram/robot_plans/actions/base/index
   /autoapi/pycram/robot_plans/actions/composite/index
   /autoapi/pycram/robot_plans/actions/core/index
...
.. autoapisummary::
   ...
   pycram.robot_plans.actions.LookAtActionDescription
   pycram.robot_plans.actions.NavigateActionDescription
   pycram.robot_plans.actions.FaceAtActionDescription
   pycram.robot_plans.actions.DetectActionDescription
   pycram.robot_plans.actions.SearchActionDescription
   pycram.robot_plans.actions.CuttingActionDescription
   pycram.robot_plans.actions.PouringActionDescription
   pycram.robot_plans.actions.MixingActionDescription
   pycram.robot_plans.actions.ParkArmsActionDescription
   pycram.robot_plans.actions.PickUpActionDescription
   pycram.robot_plans.actions.PlaceActionDescription
   pycram.robot_plans.actions.OpenActionDescription
   pycram.robot_plans.actions.TransportActionDescription
   pycram.robot_plans.actions.PickAndPlaceActionDescription
   pycram.robot_plans.actions.MoveAndPlaceActionDescription
   pycram.robot_plans.actions.MoveAndPickUpActionDescription
   pycram.robot_plans.actions.EfficientTransportActionDescription
   pycram.robot_plans.actions.GraspingActionDescription
   pycram.robot_plans.actions.OpenActionDescription
   pycram.robot_plans.actions.CloseActionDescription
   pycram.robot_plans.actions.logger
   pycram.robot_plans.actions.ReachActionDescription
   pycram.robot_plans.actions.PickUpActionDescription
   pycram.robot_plans.actions.DetectActionDescription
   pycram.robot_plans.actions.NavigateActionDescription
   pycram.robot_plans.actions.LookAtActionDescription
   pycram.robot_plans.actions.PlaceActionDescription
   pycram.robot_plans.actions.MoveTorsoActionDescription
   pycram.robot_plans.actions.SetGripperActionDescription
   pycram.robot_plans.actions.ParkArmsActionDescription
   pycram.robot_plans.actions.CarryActionDescription
   pycram.robot_plans.actions.right_park
   pycram.robot_plans.actions.left_park
   pycram.robot_plans.actions.both_park
   pycram.robot_plans.actions.left_gripper_open
   pycram.robot_plans.actions.left_gripper_close
   pycram.robot_plans.actions.right_gripper_open
   pycram.robot_plans.actions.right_gripper_close
   pycram.robot_plans.actions.torso_low
   pycram.robot_plans.actions.torso_mid
   pycram.robot_plans.actions.torso_high
   pycram.robot_plans.actions.left_arm
   pycram.robot_plans.actions.both_arm
...
.. autoapisummary::
   ...
   pycram.robot_plans.actions.PerceptionObjectNotFound
   pycram.robot_plans.actions.ObjectUnfetchable
   pycram.robot_plans.actions.ConfigurationNotReached
   pycram.robot_plans.actions.ContainerManipulationError
   pycram.robot_plans.actions.ObjectNotGraspedError
   pycram.robot_plans.actions.ObjectNotInGraspingArea
   pycram.robot_plans.actions.LookAtGoalNotReached
   pycram.robot_plans.actions.NavigationGoalNotReachedError
   pycram.robot_plans.actions.ObjectNotPlacedAtTargetLocation
   pycram.robot_plans.actions.ObjectStillInContact
   pycram.robot_plans.actions.TorsoGoalNotReached
   pycram.robot_plans.actions.ConfigurationNotReached
...
.. autoapisummary::
   ...
   pycram.robot_plans.actions.ActionConfig
   pycram.robot_plans.actions.PartialDesignator
   pycram.robot_plans.actions.PoseStamped
   pycram.robot_plans.actions.SequentialPlan
   pycram.robot_plans.actions.ActionDescription
   pycram.robot_plans.actions.FaceAtAction
   pycram.robot_plans.actions.DetectionTechnique
   pycram.robot_plans.actions.CostmapLocation
   pycram.robot_plans.actions.TryInOrderPlan
   pycram.robot_plans.actions.SearchAction
   pycram.robot_plans.actions.MoveTCPMotion
   pycram.robot_plans.actions.Arms
   pycram.robot_plans.actions.AxisIdentifier
   pycram.robot_plans.actions.Grasp
   pycram.robot_plans.actions.ApproachDirection
   pycram.robot_plans.actions.VerticalAlignment
   pycram.robot_plans.actions.RobotDescription
   pycram.robot_plans.actions.MixingAction
   pycram.robot_plans.actions.PouringAction
   pycram.robot_plans.actions.CuttingAction
   pycram.robot_plans.actions.GraspDescription
   pycram.robot_plans.actions.ProbabilisticCostmapLocation
   pycram.robot_plans.actions.GiskardLocation
   pycram.robot_plans.actions.BelieveObject
   pycram.robot_plans.actions.TransportAction
   pycram.robot_plans.actions.PickAndPlaceAction
   pycram.robot_plans.actions.MoveAndPlaceAction
   pycram.robot_plans.actions.MoveAndPickUpAction
   pycram.robot_plans.actions.EfficientTransportAction
   pycram.robot_plans.actions.OpeningMotion
   pycram.robot_plans.actions.ClosingMotion
   pycram.robot_plans.actions.MoveGripperMotion
   pycram.robot_plans.actions.ActionConfig
   pycram.robot_plans.actions.Arms
   pycram.robot_plans.actions.GripperState
   pycram.robot_plans.actions.ContainerManipulationType
   pycram.robot_plans.actions.PartialDesignator
   pycram.robot_plans.actions.SequentialPlan
   pycram.robot_plans.actions.ActionDescription
   pycram.robot_plans.actions.OpenAction
   pycram.robot_plans.actions.CloseAction
   pycram.robot_plans.actions.MoveTCPMotion
   pycram.robot_plans.actions.MovementType
   pycram.robot_plans.actions.FindBodyInRegionMethod
   pycram.robot_plans.actions.GraspDescription
   pycram.robot_plans.actions.PoseStamped
   pycram.robot_plans.actions.RobotDescription
   pycram.robot_plans.actions.ViewManager
   pycram.robot_plans.actions.ReachAction
   pycram.robot_plans.actions.PickUpAction
   pycram.robot_plans.actions.GraspingAction
   pycram.robot_plans.actions.PerceptionQuery
   pycram.robot_plans.actions.DetectionTechnique
   pycram.robot_plans.actions.DetectionState
   pycram.robot_plans.actions.DetectAction
   pycram.robot_plans.actions.LookingMotion
   pycram.robot_plans.actions.MoveMotion
   pycram.robot_plans.actions.PoseErrorChecker
   pycram.robot_plans.actions.NavigateAction
   pycram.robot_plans.actions.LookAtAction
   pycram.robot_plans.actions.ReachMotion
   pycram.robot_plans.actions.ApproachDirection
   pycram.robot_plans.actions.VerticalAlignment
   pycram.robot_plans.actions.PlaceAction
   pycram.robot_plans.actions.AxisIdentifier
   pycram.robot_plans.actions.Vector3Stamped
   pycram.robot_plans.actions.MoveJointsMotion
   pycram.robot_plans.actions.MoveTorsoAction
   pycram.robot_plans.actions.SetGripperAction
   pycram.robot_plans.actions.ParkArmsAction
   pycram.robot_plans.actions.CarryAction
   pycram.robot_plans.actions.StaticJointState
   pycram.robot_plans.actions.GripperStateEnum
   pycram.robot_plans.actions.TorsoState
   pycram.robot_plans.actions.JointState
   pycram.robot_plans.actions.ArmState
   pycram.robot_plans.actions.JointStateManager
...
.. autoapisummary::
   ...
   pycram.robot_plans.actions.has_parameters
   pycram.robot_plans.actions.quaternion_from_euler
   pycram.robot_plans.actions.has_parameters
   pycram.robot_plans.actions.validate_close_open
   pycram.robot_plans.actions.check_opened
   pycram.robot_plans.actions.check_closed
   pycram.robot_plans.actions.translate_pose_along_local_axis
   pycram.robot_plans.actions.create_multiple_joint_goal_validator
